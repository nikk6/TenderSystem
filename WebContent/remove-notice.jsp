...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<h2><center>Remove Notice</center></h2>
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td><%=rs.getString("notice_create")%></td>
							<td><a href="remove-notice-process.jsp?id=<%=rs.getInt("id")%>" class="btn btn-danger">Remove Notice</a></td>
						</tr>
					</tbody>
					<%
						}
