				...
				<form action="CreateTender" method="post">
					<div class="form-group">
						<label for="tenderName">Tender Name:</label> <input type="text"
							class="form-control" id="" placeholder="Enter Tender Name"
							name="tenderName">
					</div>
					<div class="form-group">
						<label for="tenderType">Tender Type:</label> <select class="form-control"
							name="tenderType">
					...
					<div class="form-group">
						<label for="basePrice">Base Price:</label> <input type="text"
							class="form-control" id="" placeholder="Base Price"
							name="basePrice">
					</div>
					<div class="form-group">
						<label for="strictDeadline">Strict Deadline:</label> <input type="date"
							class="form-control" 
							name="strictDeadline">
					</div>
					<div class="form-group">
						<label for="location">Location:</label> <input type="text"
							class="form-control" id="" placeholder="Location"
							name="location">
					</div>
					<div class="form-group">
						<label for="description">Description:</label> <input type="text"
							class="form-control" id="" placeholder="Description"
							name="description">
					</div>
					<button type="submit" class="btn btn-info">Create Tender</button>
