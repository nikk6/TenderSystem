...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<h2>All Assigned Tenders List</h2>
				<table class="table table-bordered">
					...
					<%
						ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbltenderstatus");
						while (rs.next()) {
					%>
					<tbody>
						<tr>
							...
							<td><%
								...
								%>	 <span class="label label-success"><%=rs.getString("status")%></span>
								<%
 									} else {%>
 								 	 <span class="label label-danger"><%=rs.getString("status")%></span>
								<%
 									}
 								%>
							</td>
							<td><%=rs.getString("tstatus_update")%></td>
						</tr>
					</tbody>
					<%
						}
